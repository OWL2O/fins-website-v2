...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8 pt-[128px] sm:pt-[150px] lg:pt-[160px] min-[1700px]:pt-[185px] pb-16 sm:pb-20 lg:pb-24 flex flex-col items-center text-center">
        ...
        {/* ── Live dashboard demo ──────────────────────────────── */}
        <div ref={demoRef} className="mt-14 sm:mt-16 w-full max-w-[1080px]" style={{ opacity: 0, willChange: 'transform' }}>
